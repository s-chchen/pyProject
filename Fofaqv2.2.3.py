...
class FofaSpider:
    ...
    def getfirstPage(self):
        url = 'https://fofa.so/result?page=1&qbase64=' + fofaSpider.query_str_qbase64_urlencode
        print("第1页 " + url)
...
if __name__ == "__main__":
    # query_str 查询字符串
    query_str = '"citrix" && title =="Citrix Gateway" && country="US"'
    Cookie = '_fofapro_ars_session=XXX;'
    ip_txt = 'ip.txt'
    ...
    fofaSpider.getfirstPage()
    fofaSpider.base(2, 500)  # 1-500
